...
public class Robot {
    ...
    public Robot(int row, int col, boolean realBot) {
        ...
        SRLeftBack = new Sensor(RobotConstants.SENSOR_SHORT_RANGE_L, RobotConstants.SENSOR_SHORT_RANGE_H, this.row + 1, this.col + 1, findNewDirection(MOVEMENT.TURNR), "SRLB");
    ...
    public void setSensors() {
        switch (robotDir) {
            case UP:
                ...
                LRRight.setSensor(this.row + 1, this.col + 1, findNewDirection(MOVEMENT.TURNR));
                break;
            case RIGHT:
                SRFrontLeft.setSensor(this.row + 1, this.col + 1, this.robotDir);
